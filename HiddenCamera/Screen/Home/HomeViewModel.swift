...
//                        self?.
                        routing.routeToInfraredCamera.onNext(())
//                    }
                } else {
...
//                    AdsInterstitial.shared.tryToPresent { [weak self] in
//                        self?.
                        routing.routeToCameraDetector.onNext(())
//                    }
                } else {
                    SubscriptionViewController.open { }
                }
...
//                    AdsInterstitial.shared.tryToPresent { [weak self] in
//                        self?.
                        routing.routeToWifiScanner.onNext(())
//                    }
                } else {
                    SubscriptionViewController.open { }
                }
...
//                    AdsInterstitial.shared.tryToPresent { [weak self] in
//                        self?.
                    routing.routeToBluetoothScanner.onNext(())
//                    }
                } else {
                    SubscriptionViewController.open { }
                }
...
//                    AdsInterstitial.shared.tryToPresent { [weak self] in
//                        self?.
                    routing.routeToMagnetic.onNext(())
//                    }
                } else {
                    SubscriptionViewController.open { }
                }
...
//        AdsInterstitial.shared.tryToPresent { [weak self] in
//            self?.
        routing.routeToScanOption.onNext(item)
//        }
    }
